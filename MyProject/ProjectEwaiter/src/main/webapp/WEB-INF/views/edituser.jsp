...
<script>
     function Project1()
	{
		...
		var UserType = document.forms["RegForm"]["userTypeId"];
...
<body>
	...
	<input type="hidden" class="mb-2 rounded" name="userId" value="${user.userId }" placeholder="Enter UserName" required><br>
	<input type="text" class="mb-2 rounded" name="userName" value="${user.userName }" placeholder="Enter UserName" required><br>
	...
	<input type="text"  class="mb-2 rounded" name="salary" value="${user.salary}" placeholder="Enter salary" required ><br>
	    ...
	    <p>USER TYPE    
        <select class="mb-2"  name="userTypeId" >
