...
<script>
     function Project()
	{
		...
		var TableID = document.forms["myForm"]["tableId"];
		var MobileNo = document.forms["myForm"]["mobileNo"];
			...
			<div class="col-6" align="center">
				<div class="jumbotron">
					...
					<form action="custLogin" name="myForm" onsubmit="return Project()"  method="post">
						...
						<input type="text" maxlength="10" pattern="[0-9]{10}" class="mb-2 rounded" name="mobileNo" placeholder="Enter Mobile Number" ><br>
												<p>
