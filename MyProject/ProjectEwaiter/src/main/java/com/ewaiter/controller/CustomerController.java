...
public class CustomerController {
	...
	public String custLogin() {
		...
		try{flag = session.getAttribute("loggedCustId")==null;}catch(NullPointerException e) {System.out.println(e);}
	...
	public String custLogin(Customer customer) {
		...
		if(customer.getName().equals(null)||customer.getMobileNo().equals(null)||customer.getTableId()==0)
			return "index";
		
		
		//If data is not null then session variable loggedcust is populated with customer id.
